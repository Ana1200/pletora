                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="form-check form-switch form-switch-sm">
                                        <input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault"data-id="<?php echo $ID;?>"data-status="<?php echo $status;?>"  onchange="toggleActivationCola(this)" <?php echo $isChecked; ?>>
